...
console.log("kashiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii")
...
req.flash('success',"Books Deleted");
req.flash('/manage/books');
res.redirect('/manage/books');
